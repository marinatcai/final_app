    ...
    <>
        <div className="flex flex-col justify-items items-center mt-20">  
            ...
            <div className="bg-white h-200 w-200 rounded-2xl drop-shadow-black drop-shadow-2xl mb-10">
                <div className="flex justify-items justify-between mt-20">
                <div className="h-120 w-0.5 bg-black ml-20"></div>
                    <div className="h-80 w-25 bg-[#6192D3] rounded-[10px_10px_0px_0px] mr-15 mt-40">
                        <h3 className="text-center text-white text-2xl alfa-slab pt-5">30</h3>
                    </div>
                    <div className="h-100 w-25 bg-[#E85C6A] rounded-[10px_10px_0px_0px] mr-15 mt-20">
                        <h3 className="text-center text-white text-2xl alfa-slab pt-5">35</h3>
                    </div>
                    <div className="h-110 w-25 bg-[#BA67C5] rounded-[10px_10px_0px_0px] mr-30 mt-10">
                        <h3 className="text-center text-white text-2xl alfa-slab pt-5">39</h3>
                    </div>
                </div>
                <div className="h-0.5 w-160 bg-black ml-20 mb-10"></div>
